                    ...
                    <div class="modal-body d-flex flex-col gap-3">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 form-group mb-0">
                                ...
                                <input type="text" class="form-control <?php if ($currentUser['role'] !== 'admin') echo 'bg-light'; ?>" id="profileFirstName" required <?php if ($currentUser['role'] !== 'admin')
                                    echo 'readonly'; ?>>
                            </div>
                            <div class="col-md-6 form-group mb-0">
                                <label for="profileLastName" class="form-label">Last Name</label>
                                <input type="text" class="form-control <?php if ($currentUser['role'] !== 'admin') echo 'bg-light'; ?>" id="profileLastName" required <?php if ($currentUser['role'] !== 'admin')
                                    echo 'readonly'; ?>>
                            </div>
                        </div>
