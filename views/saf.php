...
<body style="height: 100%;"><!-- Dashboard Screen -->
    ...
    <?php if ($currentUser['role'] === 'employee' && stripos($currentUser['position'] ?? '', 'Accounting') !== false): ?>
      <div class="container-fluid p-4">
        <div class="alert alert-info">
          ...
          <p>As Accounting Personnel, you can approve pending SAF documents. Click below to access the approval system.
          </p>
        ...
        <div class="col-lg-8 mx-auto">
              ...
              <div class="row g-3">
                <div class="col-md-4">
                  <div class="p-3 bg-primary bg-opacity-10 rounded">
                    <div class="d-flex align-items-center mb-2"><i class="bi bi-wallet2 text-primary me-2"></i> <small
                        class="text-muted fw-semibold">Initial Amount</small>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="p-3 bg-danger bg-opacity-10 rounded">
                    <div class="d-flex align-items-center mb-2"><i class="bi bi-arrow-down-circle text-danger me-2"></i>
                      <small class="text-muted fw-semibold">Used Amount</small>
                    </div>
                ...
                <div class="col-md-4">
                  <div class="p-3 bg-success bg-opacity-10 rounded">
                    <div class="d-flex align-items-center mb-2"><i class="bi bi-check-circle text-success me-2"></i>
                      <small class="text-muted fw-semibold">Current Balance</small>
                    </div>
          ...
          <div id="level3-controls" class="card shadow-sm mb-4" style="display: none;">
            <div class="card-body">
              ...
              <div class="d-flex flex-wrap gap-2"><button class="btn btn-success" onclick="showEditModal('add')"> <i
                    class="bi bi-plus-circle me-1"></i>Add Funds </button> <button class="btn btn-danger"
                  onclick="showEditModal('deduct')"> <i class="bi bi-dash-circle me-1"></i>Deduct Funds </button>
                <button class="btn btn-primary" onclick="showEditModal('set')"> <i
                    class="bi bi-pencil-square me-1"></i>Set Initial Amount </button> <button
                  class="btn btn-outline-danger" onclick="showResetConfirm()"
                  title="Reset all SAF data and transaction history"> <i
                    class="bi bi-arrow-counterclockwise me-1"></i>Reset SAF Data </button>
              </div>
            </div>
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body p-0">
              <div id="transaction-list" class="list-group list-group-flush"
                ...
                <div class="text-center py-5 text-muted"><i class="bi bi-inbox"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-title">Edit SAF</h5><button type="button" class="btn-close"
            data-bs-dismiss="modal"></button>
        </div>
        <form id="edit-form" onsubmit="handleEditSubmit(event)">
          <div class="modal-body"><input type="hidden" id="edit-type">
            <div class="mb-3"><label for="edit-amount" class="form-label fw-semibold">Amount (₱)</label> <input
                type="number" class="form-control form-control-lg" id="edit-amount" min="0" step="0.01" required
                placeholder="0.00">
            </div>
            <div class="mb-3"><label for="edit-description" class="form-label fw-semibold">Description</label> <input
                type="text" class="form-control" id="edit-description" required
                placeholder="Enter transaction description">
            </div>
          </div>
          <div class="modal-footer"><button type="button" class="btn btn-secondary"
              data-bs-dismiss="modal">Cancel</button> <button type="submit" id="modal-submit-btn"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-danger">
        ...
        <div class="modal-body text-center p-4">
          ...
          <p class="text-muted mb-0"><strong>This action cannot be undone.</strong> All fund allocation data and
            transaction records for this department will be permanently deleted.</p>
        </div>
  ...
  <div id="loading-overlay" class="spinner-wrapper" style="display: none;">
    <div class="spinner-border text-light" role="status" style="width: 3rem; height: 3rem;"><span
  ...
  <div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="toast" class="toast align-items-center border-0" role="alert">
      <div class="d-flex">
        <div class="toast-body fw-semibold" id="toast-message"></div><button type="button"
